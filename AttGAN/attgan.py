...
class Discriminators(nn.Module):
    ...
    def __init__(self, dim=64, norm_fn='instancenorm', acti_fn='lrelu',
                 fc_dim=1024, fc_norm_fn='none', fc_acti_fn='lrelu', n_layers=5, n_attrs=13, img_size=128):
...
class AttGAN():
    def __init__(self, args):
        ...
        self.D = Discriminators(
            ...
            args.dis_fc_dim, args.dis_fc_norm, args.dis_fc_acti, args.dis_layers, args.n_attrs, args.img_size
        )
        self.D.train()
